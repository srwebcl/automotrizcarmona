                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="space-y-5">
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="pt-2"><Link href="/sobre-nosotros" className="hover:text-white transition-colors flex items-center gap-2 group"><ArrowRight size={14} className="text-gray-600 transform group-hover:translate-x-1 group-hover:text-carmona-gold transition-all" /> Sobre Nosotros</Link></li>
                            <li><Link href="/sucursales" className="hover:text-white transition-colors flex items-center gap-2 group"><ArrowRight size={14} className="text-gray-600 transform group-hover:translate-x-1 group-hover:text-carmona-gold transition-all" /> Sucursales</Link></li>
