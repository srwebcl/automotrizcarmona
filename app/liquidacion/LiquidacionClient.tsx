        ...
        <>
            ...
            <section className="pt-12 pb-2 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-medium text-gray-900 tracking-tight mb-3">
            ...
            {/* UNITS GRID */}
            <section className="max-w-[1920px] mx-auto px-4 md:px-8 py-12 bg-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-20">
                        {filteredUnits.map((unit, idx) => (
                            <div key={`${unit.vin}-${idx}`} className="group flex flex-col">
                                ...
                                {/* Price Info - More Compact and Closer */}
                                <div className="mt-14 px-2 text-center">
                                    <div className="flex flex-col items-center">
                                        <div className="flex items-center gap-3 mb-2">
                                            <span className="text-[10px] font-bold text-gray-300 line-through decoration-gray-400/50">
                                                {formatPrice(unit.listPrice || (unit.promoPrice + unit.promoBonus))}
                                            </span>
                                            <span className="text-[10px] font-black text-[#d2001c] uppercase tracking-wider bg-[#d2001c]/5 px-2 py-0.5 rounded">
                                                -{formatPrice(unit.promoBonus)}
                                            </span>
                                        </div>
                                        
                                        <div className="mb-4">
                                            <p className="text-[8px] font-black text-gray-400 uppercase tracking-[0.15em] mb-0.5">Precio Liquidación</p>
                                        ...
                                        <Link 
                                            ...
                                            className="w-full inline-flex items-center justify-center gap-2 py-3.5 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-[#d2001c] transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-100 group/btn"
                                        >
                                            Cotizar Unidad <ArrowRight size={16} className="group-hover/btn:translate-x-1.5 transition-transform" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
