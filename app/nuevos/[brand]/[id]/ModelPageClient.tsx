...
export default function ModelPageClient({ brand, id, initialModel, config, legalExcerpt }: { brand: string; id: string; initialModel: any; config: any; legalExcerpt?: string | null }) {
        ...
        <main className="min-h-screen bg-[#f4f6f8] font-sans pt-[80px]">
            ...
            {model.desktopBanner ? (
                brand === 'bmw-motorrad' ? (
                    ...
                    <section className={`relative w-full bg-black border-b border-gray-100 overflow-hidden ${['cupra', 'kaiyi', 'volkswagen', 'bmw', 'audi', 'seat', 'dongfeng'].includes(brand) ? 'h-[60vh] md:h-[calc(100vh-76px)]' : ''}`}>
                        <picture className="w-full h-full block">
                            ...
                            <img 
                                ...
                                className={`w-full ${['cupra', 'kaiyi', 'volkswagen', 'bmw', 'audi', 'seat', 'dongfeng'].includes(brand) ? 'h-full' : 'h-auto md:h-auto'} object-cover opacity-80`} 
                            />
                        </picture>
                        {['cupra', 'kaiyi', 'volkswagen', 'bmw', 'audi', 'seat', 'dongfeng'].includes(brand) && (
                            <>
